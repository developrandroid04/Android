...
public class PdfRendererBasicFragment extends Fragment implements View.OnClickListener {
     ...
     */
    private String FILENAME = "terms.pdf";
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        ((TextView) view.findViewById(R.id.tv_page_no)).setText("Page - " + mPageIndex);
    }
    ...
    private void updateUi() {
        ...
        ((TextView) mRootView.findViewById(R.id.tv_page_no)).setText(getString(R.string.app_name_with_index, index + 1, pageCount));
